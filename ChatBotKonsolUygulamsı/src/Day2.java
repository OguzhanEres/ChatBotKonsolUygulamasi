...
public class Day2 extends Lessons implements Routines,Places,Detay {
    Scanner scanner=new Scanner(System.in);
    //bugün olan derlerim hakkında bilgi veren bir void fonksiyon
    void Derslerim(){
        System.out.println("Bugün iki tane dersim var.Salı günleri 9.30'da OOP dersim ve bu ders 11.00 civarında bitiyor öğle arasından sonra " +
                "ise 13.30 Gürhan Hoca ile Diferansiye Denklemler dersim var ");
        System.out.println("Derslerim hakkında bilgi vermek gerekirse: "+OOP()+" "+Diff());
    }
    ...
    @Override
    public void Food() {
        System.out.println("Öğle arası bölümden arkadaşlarım ile yemekhanede yemek yedim akşam eve gittiğimde ise ev arkadaşımla yemek yapıp yedik");
        int karar;
        System.out.println("Hakkımda daha fazla bilgi için 1 giriniz yoksa 0 giriniz:");
        karar=scanner.nextInt();
        if (karar==1){
    ...
    @Override
    public void Home() {
        System.out.println("Salı günü akşam eve 23.17'de geldim");
        int karar;
        System.out.println("Hakkımda daha fazla bilgi için 1 giriniz yoksa 0 giriniz:");
        karar=scanner.nextInt();
        if (karar==1) {
    ...
    public void Harboor() {
        int bilgi;
        System.out.println( "Diff dersinden sonra arakadaşımın kafesine gittim ve kapatana kadar orda oturduk");
        int karar;
        System.out.println("Hakkımda daha fazla bilgi için 1 giriniz yoksa 0 giriniz:");
    ...
    @Override
    public void Konser() {
        System.out.println("Salı konsere gitmedim");
        int karar;
        System.out.println("Hakkımda daha fazla bilgi için 1 giriniz yoksa 0 giriniz:");
        karar=scanner.nextInt();
        if (karar==1){
    ...
    @Override
    public void School() {
        System.out.println("Salı günü sabah 9.30'dan çğleden sonra 15.30'a kadar okuldaydım");
        int karar;
        System.out.println("Hakkımda daha fazla bilgi için 1 giriniz yoksa 0 giriniz:");
        karar=scanner.nextInt();
        if (karar==1){
    ...
    void aktivite_yazdir(){
        int dongu_karar=1;
        do{
            //gün içi aktiviteleri kullanıcya sunma
